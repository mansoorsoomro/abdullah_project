                        ...
                        >
                            ...
                            <div className="p-8 border-b border-white/10 text-center relative overflow-hidden">
                                <div className="absolute top-4 right-6 text-[9px] font-mono text-gray-500 tracking-tighter uppercase opacity-50">
                                    REF: {Math.random().toString(36).substring(2, 10).toUpperCase()} // {new Date(showReceipt.purchaseDate).toLocaleString()}
                                </div>
                                <div className="mb-6 flex justify-center scale-110 drop-shadow-[0_0_15px_rgba(220,38,38,0.5)]">
                                    <img src="/logo_header.PNG" alt="WARZONE" className="h-10 object-contain" />
                                </div>
                            ...
                            <div className="p-8 space-y-6 flex-1 font-mono relative">
                                ...
                                <div className="grid grid-cols-1 gap-6 text-xs">
                                    <div className="bg-white/[0.02] p-6 rounded-2xl border border-white/10 relative group-hover:border-red-600/40 transition-all shadow-inner">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div className="bg-white/[0.03] p-5 rounded-2xl border border-white/10 hover:border-red-600/30 transition-colors">
                                    ...
                                    <div className="bg-white/[0.02] p-5 rounded-2xl border border-white/5 grid grid-cols-2 gap-6">
                                        <div>
                                ...
                                <div className="pt-8 border-t border-white/10 flex justify-between items-center bg-gradient-to-b from-transparent to-white/[0.01] -mx-8 px-8 pb-4">
                            ...
                            <div className="p-8 bg-[#0a0a0a] border-t border-white/5">
                                ...
                                >
                                    ...
                                    <div className="absolute inset-0 bg-white translate-x-[-100%] group-hover/btn:translate-x-0 transition-transform duration-500"></div>
                                </button>
